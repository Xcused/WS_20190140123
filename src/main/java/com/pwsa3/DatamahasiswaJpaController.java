...
import com.pwsa3.exceptions.NonexistentEntityException;
import com.pwsa3.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.pwsa_20190140123_jar_0.0.1-SNAPSHOTPU");
